...
SECRET_KEY = 'django-insecure--n4grh0-%za8$d%zu-h*@rb*+a66we5^_z1xsbcxsodfqtp3@f'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # 替换为 JWT 认证
    ...
    'EXCEPTION_HANDLER': 'auth_service.responses.custom_exception_handler',
    # Custom renderer
    'DEFAULT_RENDERER_CLASSES': (
        'auth_service.responses.CustomRenderer',
    )
}
