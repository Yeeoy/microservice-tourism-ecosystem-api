...
from rest_framework_simplejwt.authentication import JWTAuthentication  # 修改这一行
from rest_framework.permissions import IsAuthenticated
from customUser.serializers import (
    UserSerializer,
    AuthTokenSerializer, EventLogSerializer, CustomTokenObtainPairSerializer
)
...
class ManageUserView(generics.RetrieveUpdateAPIView):
    serializer_class = UserSerializer
    authentication_classes = (JWTAuthentication,)  # 使用修改后的导入
...
@extend_schema(tags=["AUTH - Health"])
