...
MIDDLEWARE = [
    ...
    "restaurant.RequestLoggingMiddleware.RequestLoggingMiddleware",
]
...
AUTHENTICATION_BACKENDS = [
    ...
    'restaurant.auth_backend.JWTAuthBackend',  # 添加自定义 JWT 认证
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'restaurant.auth_backend.JWTAuthBackend',
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',
    ],
    'EXCEPTION_HANDLER': 'restaurant.responses.custom_exception_handler',
    'DEFAULT_RENDERER_CLASSES': (
        'restaurant.responses.CustomRenderer',
    )
}
