...
class TableReservationAdmin(admin.ModelAdmin):
    list_display = ('restaurant', 'user_id', 'reservation_date', 'reservation_time', 'number_of_guests', 'reservation_status')
    search_fields = ('restaurant__name', 'user_id')
...
class OnlineOrderAdmin(admin.ModelAdmin):
    list_display = ('restaurant', 'user_id', 'order_date', 'order_time', 'total_amount', 'order_status')
    search_fields = ('restaurant__name', 'user_id', 'order_status')
