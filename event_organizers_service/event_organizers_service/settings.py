"""
Django settings for event_organizers_service project.
...
MIDDLEWARE = [
    ...
    "event_organizers.RequestLoggingMiddleware.RequestLoggingMiddleware",
]

ROOT_URLCONF = 'event_organizers_service.urls'
...
WSGI_APPLICATION = 'event_organizers_service.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    ...
    'event_organizers.auth_backend.JWTAuthBackend',  # 添加自定义 JWT 认证
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'event_organizers.auth_backend.JWTAuthBackend',
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',
    ],
    'EXCEPTION_HANDLER': 'event_organizers.responses.custom_exception_handler',
    'DEFAULT_RENDERER_CLASSES': (
        'event_organizers.responses.CustomRenderer',
    )
}
